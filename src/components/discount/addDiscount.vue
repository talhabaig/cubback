  ...
  <v-row>
    <v-col class="col-6">
      ...
      <div class="right-inner-addon input-container pb-0">
       ...
       <div class="invalid-feedback" v-if="$v.discountModel.discount_name.$error">
        <span v-if="$v.discountModel.discount_name.$error">Name is required</span>
      </div>
      <!-- <v-text-field
          v-model="discountModel.discount_name"
    ...
    <v-col class="col-6">
      ...
      >
        ...
        <div class="invalid-feedback" v-if="$v.discountModel.discount_start_date.$error">
        <span v-if="$v.discountModel.discount_start_date.$error">Start Date is required</span>
      </div>
    </v-col>
    <v-col class="col-6">
      <v-menu
      ...
      >
        ...
        <div class="invalid-feedback" v-if="$v.discountModel.discount_end_date.$error">
        <span v-if="$v.discountModel.discount_end_date.$error">End Date is required</span>
      </div>
    </v-col>
    <v-col class="col-3">
      <label class="regularFont login-font" style=""
    ...
    <v-col class="col-3">
      ...
      <div class="right-inner-addon input-container pb-0">
        ...
        />
         ...
         <div class="invalid-feedback" v-if="$v.discountModel.discount_value.$error">
        <span v-if="$v.discountModel.discount_value.$error">Value is required</span>
      </div>
      <!-- <v-text-field
          v-model="discountModel.discount_value"

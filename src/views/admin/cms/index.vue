        ...
        >
          <template v-slot:activator="{ on, attrs }">
            <v-btn dark color="main_bg_color" v-bind="attrs" v-on="on">
              <i class="fas fa-plus mr-2"></i>Add Page  </v-btn
            >
          </template>
            ...
            <v-card>
              <v-toolbar color="main_bg_color" dark class="mb-2">
                <span v-if="isEdit == false"
                  ><i class="fas fa-stream Orders mr-2"></i>Add Page  </span
                >
                <span v-else
                  ><i class="fas fa-stream Orders mr-2"></i>Edit Page  </span
                >
              </v-toolbar>
              <v-card-text>
